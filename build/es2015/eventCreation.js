...
if (!supportThisTypeAttribute('datetime-local')) {
  ...
  document.getElementById('startDate').setAttribute('data-date-format', 'yyyy-mm-dd hh:ii');
  $('#startDate').datetimepicker();

  document.getElementById('endDate').setAttribute('type', 'text');
  document.getElementById('endDate').setAttribute('data-date-format', 'yyyy-mm-dd hh:ii');
...
function checkEventName(e) {
  ...
  if (errorMsg.length > 0) {
    ...
    document.getElementById('eventName').setAttribute('class', 'errorBorder');
  }
}
...
function checkEventType(e) {
  ...
  if (errorMsg.length > 0) {
    ...
    document.getElementById('eventType').setAttribute('class', 'errorBorder');
  }
}
...
function checkEventHost(e) {
  ...
  if (errorMsg.length > 0) {
    ...
    document.getElementById('eventHost').setAttribute('class', 'errorBorder');
  }
}
...
function checkEventStartDate(e) {
  ...
  if (errorMsg.length > 0) {
    ...
    document.getElementById('startDate').setAttribute('class', 'errorBorder');
  }
}
...
function checkEventEndDate(e) {
  ...
  if (errorMsg.length > 0) {
    ...
    document.getElementById('endDate').setAttribute('class', 'errorBorder');
  }
}
...
function checkEventLocation(e) {
  ...
  if (errorMsg.length > 0) {
    ...
    document.getElementById('location').setAttribute('class', 'errorBorder');
  }
}
...
function checkMessage(e) {
  ...
  if (errorMsg.length > 0) {
    ...
    document.getElementById('message').setAttribute('class', 'errorBorder');
  }
}
